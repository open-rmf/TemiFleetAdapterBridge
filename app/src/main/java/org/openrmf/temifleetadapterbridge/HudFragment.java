...
public class HudFragment extends Fragment {
  ...
  public void onStart() {
    ...
    if (args != null) {
      videoCallEnabled = args.getBoolean(org.openrmf.temifleetadapterbridge.CallActivity.EXTRA_VIDEO_CALL, true);
      displayHud = args.getBoolean(org.openrmf.temifleetadapterbridge.CallActivity.EXTRA_DISPLAY_HUD, false);
    }
  ...
  public void setCpuMonitor(org.openrmf.temifleetadapterbridge.CpuMonitor cpuMonitor) {
  ...
  public void updateEncoderStatistics(final StatsReport[] reports) {
    ...
    for (StatsReport report : reports) {
      if (report.type.equals("ssrc") && report.id.contains("ssrc") && report.id.contains("send")) {
        ...
        if (trackId != null && trackId.contains(org.openrmf.temifleetadapterbridge.PeerConnectionClient.VIDEO_TRACK_ID)) {
