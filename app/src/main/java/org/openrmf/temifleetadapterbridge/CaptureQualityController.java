...
public class CaptureQualityController implements SeekBar.OnSeekBarChangeListener {
  ...
  private org.openrmf.temifleetadapterbridge.CallFragment.OnCallEvents callEvents;
  private int width;
  private int height;
  ...
  public CaptureQualityController(
      TextView captureFormatText, org.openrmf.temifleetadapterbridge.CallFragment.OnCallEvents callEvents) {
