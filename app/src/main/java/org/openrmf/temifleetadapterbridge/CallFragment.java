...
public class CallFragment extends Fragment {
  ...
  public void onStart() {
    ...
    if (args != null) {
      String contactName = args.getString(org.openrmf.temifleetadapterbridge.CallActivity.EXTRA_ROOMID);
      contactView.setText(contactName);
      videoCallEnabled = args.getBoolean(org.openrmf.temifleetadapterbridge.CallActivity.EXTRA_VIDEO_CALL, true);
      captureSliderEnabled = videoCallEnabled
          && args.getBoolean(org.openrmf.temifleetadapterbridge.CallActivity.EXTRA_VIDEO_CAPTUREQUALITYSLIDER_ENABLED, false);
    }
    if (!videoCallEnabled) {
